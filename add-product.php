					...
					<article class="card-body">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
							  <label>Photo 1</label>
							  <input type="text" class="form-control" name="txtphoto1" id="txtphoto1" placeholder="" required>
							</div> <!-- form-group end.// -->
							<div class="form-group col-md-6">
							  <label>Photo 2</label>
							  <input type="text" class="form-control" name="txtphoto2" id="txtphoto2" placeholder="" required>
							</div> <!-- form-group end.// -->
						</div> <!-- form-row.// -->
						<div class="form-row">
							<div class="form-group col-md-6">
